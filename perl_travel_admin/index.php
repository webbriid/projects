            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Hello, <?= $login_user ?>
                        </h3>
            ...
            <div class="container-fluid">
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        ...
                                        try {
                                            $stmt = $pdo->query("SELECT COUNT(*) as totalUsers FROM user_details");
                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    try {
                                        $stmt = $pdo->query("SELECT COUNT(*) as totalEnquiry FROM enquiry");
                                        $result = $stmt->fetch(PDO::FETCH_ASSOC);
                                        $totalEnquiry = $result['totalEnquiry'];
                                    } catch (PDOException $e) {
                                        echo "Error: " . $e->getMessage();
                                    }
                                    ?>
                                    <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium"><?= $totalEnquiry ?>
                                    </h2>
                    ...
                    <div class="card border-right">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                              ...
                              try {
                                  $stmt = $pdo->query("SELECT COUNT(*) as totalBlogs FROM blog_details");
                                  $result = $stmt->fetch(PDO::FETCH_ASSOC);
                              ...
                              ?>
                                        <h2 class="text-dark mb-1 font-weight-medium"><?=$totalBlogs?></h2>
                                  
                                    </div>
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Blogs</h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                              ...
                              try {
                                  $stmt = $pdo->query("SELECT COUNT(*) as totalPackages FROM tour_package");
                                  $result = $stmt->fetch(PDO::FETCH_ASSOC);
                              ...
                              ?>
                                    <h2 class="text-dark mb-1 font-weight-medium"><?=$totalPackages?></h2>
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Packages
                                    </h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Recent Enquireis</h4>
